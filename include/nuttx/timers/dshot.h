...
#  endif
#  define DSHOT_NCHANNELS CONFIG_DSHOT_NCHANNELS
#else
#  define DSHOT_NCHANNELS 1
#endif
...
{
  uint16_t ch_mask;
  struct dshot_ch_telemetry_s ch_telemetry[DSHOT_NCHANNELS];
};
...
{
  uint16_t throttle[DSHOT_NCHANNELS];
  uint16_t ch_mask;
  uint16_t telemetry_req;
  struct dshot_ch_telemetry_s ch_telemetry[DSHOT_NCHANNELS];
};
